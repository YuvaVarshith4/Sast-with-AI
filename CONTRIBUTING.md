# Contributing to SAST AI

First off, thank you for considering contributing to SAST AI! Whether you're fixing a bug, adding a feature, or improving the workflow, your help makes this project better. If you are working from a copy of this repository in your own GitHub organization, the same steps below still apply.
...
1. **Create your branch from `main`** in your fork or working copy of the repository
...
1. Clone your fork or working copy of the repository:
```bash
git clone https://github.com/YOUR_USERNAME/ai-sast.git
cd ai-sast
```

If you copied this project into your own GitHub repository, replace the example URL above with your repository URL.
