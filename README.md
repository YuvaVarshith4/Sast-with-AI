# SAST AI - AI-Powered Static Application Security Testing
...
SAST AI is an AI-driven static application security testing tool. Use it in **your** GitHub repositories to run PR scans and full-repository scans without sending your source code to third-party infrastructure.
## Features
...
![SAST AI Architecture](docs/images/architecture.png)
...
- **Setup:** Use your own copy of this repository, then set the repository variable `AI_SAST_REPO` to that copy (for example, `your-username/ai-sast`).
...
Made with ❤️ by the SAST AI community
